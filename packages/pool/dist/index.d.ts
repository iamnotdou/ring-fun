...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CB65QXDBUJO6PR7WVKPWVUZSX76UGLQV26LK3ZP24CXJHD4DSF6KXQLV";
    };
};
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_quote: (json: string) => AssembledTransaction<bigint>;
        deploy_to_dex: (json: string) => AssembledTransaction<null>;
        get_pool_info: (json: string) => AssembledTransaction<Pool>;
    };
}
