...
function Footer() {
  return (
    <footer>
      <div className="relative mx-auto w-full max-w-6xl overflow-hidden border-white px-4 py-3 xl:overflow-visible xl:px-0">
        <div className="flex w-full items-center justify-between text-white">
          ...
          <p className="text-base-500 text-sm font-normal text-balance">
            Build with ❤️
          </p>
        </div>
      </div>
